...
P__SYSCALL_DEFINEx(2, _rt_sigpending, sigset_t __user *, uset, size_t, sigsetsize);
...
P__SYSCALL_DEFINEx(4, _rt_sigaction, int, sig,
		const struct sigaction __user *, act,
		struct sigaction __user *, oact,
		size_t, sigsetsize);

P__SYSCALL_DEFINEx(2, _rt_sigsuspend, sigset_t __user *, unewset, size_t, sigsetsize);
P__SYSCALL_DEFINEx(6, _pselect6, int, n, fd_set __user *, inp, fd_set __user *, outp,
